...
```
Для того чтобы развернуть базу данных выполните
```
python manage.py migrate
```
Для создания суперпользователя админки выполните
```
...
### Что было улучшено по сравнению с исходником:
- теперь сайт работает с базой данных, а не с `json`, добавляйте покемонов, места их появления и другие харакетристики
прямо из админки.